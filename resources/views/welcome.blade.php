          ...
          <div class="overflow-hidden bg-white rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
            ...
            <div role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
              ...
              <div role="none">
                ...
                @auth
                <a href="{{ route('dashboard') }}" class="block w-full px-5 py-3 font-medium text-center text-indigo-600 bg-gray-50 hover:bg-gray-100" role="menuitem">
                  Admin
                </a>

                @else
                <a href="{{ route('login') }}" class="block w-full px-5 py-3 font-medium text-center text-indigo-600 bg-gray-50 hover:bg-gray-100" role="menuitem">
                    Log in
                  </a>
